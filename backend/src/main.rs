...
async fn main() {
    ...
    let protected = Router::new()
        ...
        .route("/api/rekammedis/mutasi-berkas", post(handlers::rekammedis::post_mutation))
        .route("/api/rekammedis/picking-list", get(handlers::picking::get_picking_list))
        .route("/api/pasien/update-rak", put(handlers::pasien::update_shelf))
        .layer(middleware::from_fn(mw::require_auth));
